...
def run_quiz():
    score = 0
    random.shuffle(quiz_questions)  # Mélange les questions
    
    print("\n🎓 Welcome to the English Grammar Quiz! 🎓")
    print("Select the correct answer (A, B, or C).\n")
    ...
    for i, (question, options, correct_answer) in enumerate(quiz_questions, 1):
        ...
        if user_answer == correct_answer:
            ...
            print(f"❌ Incorrect. The correct answer is {correct_answer}) {options[ord(correct_answer) - 65]}.\n")
